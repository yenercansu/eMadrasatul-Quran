...
/**
 * Repeat Section Sheet — pixel-aligned to the design.
 * "hold and select the section you'd like to listen to on repeat"
 *
 * UX: tap-to-select (NOT drag). First tap sets start, second tap sets end.
 * Tapping the same ayah twice selects only that ayah.
 */
  ...
  return (
    <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose}>
      ...
      <View style={[s.sheet, { paddingBottom: insets.bottom + 20 }]}>
        ...
        <Text style={s.hint}>tap the ayahs you'd like to listen to on repeat</Text>
        ...
        >
          ...
          <Text style={s.saveBtnText}>Save & Repeat</Text>
        </TouchableOpacity>
      </View>
    </Modal>
  );
